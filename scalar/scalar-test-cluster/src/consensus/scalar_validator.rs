...
use crate::core::checkpoints::CheckpointServiceNotify;
...
impl ScalarTxValidator {
    pub fn new(
        ...
        info!(
            "ScalarTxValidator constructed for epoch {}",
            epoch_store.epoch()
        );
        Self {
            epoch_store,
...
#[async_trait]
impl TransactionValidator for ScalarTxValidator {
...
#[async_trait]
impl BlockVerifier for ScalarTxValidator {
    type Error = eyre::Report;
...
mod tests {
    ...
    async fn accept_valid_transaction() {
        ...
        let metrics = ScalarTxValidatorMetrics::new(&Default::default());
        let validator = ScalarTxValidator::new(
